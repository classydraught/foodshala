            ...
            <div className="row h-100 justify-content-center align-items-center mt-3">
                ...
                <div className="col-md-4 col-12">
                    <div className="my-card register-card">
                        <h2 className="text-center mt-2" style={{ fontFamily: "Montserrat" }}>Register</h2>
                        <h4 className="text-center mt-1" style={{ fontFamily: "Montserrat" }}>for having <span style={{ fontFamily: "lobster" }}>&nbsp;foodgasm</span></h4>
                        <Divider />
